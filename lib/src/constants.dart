...
class Api {
  static const registerWithUsername = '/hserve/v2.1/register/username/';
  static const registerWithEmail = '/hserve/v2.1/register/email/';
  static const registerWithPhone = '/hserve/v2.1/register/phone/';
  static const loginWithUsername = '/hserve/v2.1/login/username/';
  static const loginWithEmail = '/hserve/v2.1/login/email/';
  static const loginWithPhone = '/hserve/v2.1/login/phone/';
  static const loginWithSms = '/hserve/v2.1/login/sms/';
